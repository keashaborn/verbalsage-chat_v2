...
export async function GET(req: NextRequest, ctx: { params: Promise<{ meal_plan_id: string }> }) {
  ...
  const upstream = new URL(`${BRAINS_URL}/lifeswitch/nutrition/meal_plans/${encodeURIComponent(meal_plan_id)}/items`);
