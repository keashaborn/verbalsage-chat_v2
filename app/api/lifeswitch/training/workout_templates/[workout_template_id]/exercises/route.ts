...
export async function GET(req: NextRequest, ctx: { params: Promise<{ workout_template_id: string }> }) {
  ...
  const upstream = new URL(
    `${BRAINS_URL}/lifeswitch/training/workout_templates/${encodeURIComponent(workout_template_id)}/exercises`
  );
