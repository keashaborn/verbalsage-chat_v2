...
export async function POST(
  ...
  const upstream = new URL(
    `${BRAINS_URL}/lifeswitch/training/sessions/${encodeURIComponent(training_session_id)}/sets/${encodeURIComponent(training_set_log_id)}/update`
  );
  ...
  for (const key of ["exercise_sort_order", "set_index", "weight", "reps", "flags", "notes"]) {
