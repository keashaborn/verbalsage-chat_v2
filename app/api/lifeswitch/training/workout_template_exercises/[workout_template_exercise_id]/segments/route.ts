...
export async function GET(req: NextRequest, ctx: { params: Promise<{ workout_template_exercise_id: string }> }) {
  ...
  const upstream = new URL(
    `${BRAINS_URL}/lifeswitch/training/workout_template_exercises/${encodeURIComponent(workout_template_exercise_id)}/segments`
  );
